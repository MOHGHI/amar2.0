...
return [
     ...
     *
     */
    'title' => config('app.name', 'Amar') . ' Installer',
    'next' => 'Next Step',
    'back' => 'Previous',
    'finish' => 'Install',
    'forms' => [
     ...
     */
    'installed' => [
        'success_log_message' => config('app.name', 'Amar') . ' Installer successfully INSTALLED on ',
    ],
    ...
    'updater' => [
         ...
         *
         */
        'title' => config('app.name', 'Amar') . ' Updater',
        ...
        'log' => [
            'success_message' => config('app.name', 'Amar') . ' Installer successfully UPDATED on ',
        ],
    ],
];
