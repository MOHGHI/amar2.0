...
@section('content')
	...
	<div class="container-fluid main-dashboard-wrapper">
		<div class="row upper-cards hidden">
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body">
						<ul class="news-list">
							<li>
								...
								<h6>Upcoming changes to programme policies</h6>
								<a href="#">Read More ></a>
							</li>
							<li>
								<small>JUN 25, 2020</small>
								<h6>Covid-19 Related Announcements, updated: 6/24/20, 7 p.m.</h6>
								<a href="#">Read More ></a>
							</li>
							<li>
								<small>JUN 25, 2020</small>
								<h6>Some other announcements related to the platform </h6>
								<a href="#">Read More ></a>
							</li>
						</ul>
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body">
						<h5>I am kept informed of changes that impact my Amar selling business</h5>
						<div class="form-check">
							<label>
								<input type="radio" name="radio" checked> <span class="label-text">Strongly Agree</span>
							</label>
						</div>
						<div class="form-check">
							<label>
								<input type="radio" name="radio"> <span class="label-text">Agree</span>
							</label>
						</div>
						<div class="form-check">
							<label>
								<input type="radio" name="radio"> <span class="label-text">Neither Agree nor Disagree</span>
							</label>
						</div>
						<div class="form-check">
							<label>
								<input type="radio" name="radio" disabled> <span class="label-text">Disagree</span>
							</label>
						</div>
						<div class="form-check">
							<label>
								<input type="radio" name="radio" disabled> <span class="label-text">Strongly Disagree</span>
							</label>
						</div>
					</div>
					<div class="card-footer">
			...
			<div class="col-md-3">
				<div class="card">
					<div class="card-header">
						<h4>Tutorials and Training</h4>
					</div>
					<div class="card-body">
						<h5>Learn how to sell on Amar</h5>
						<img width="100%" src="https://cdn.pixabay.com/photo/2018/07/25/20/29/ecommerce-3562191_1280.jpg" alt="">
					</div>
					<div class="card-footer">
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="news-list">
							<li>
								<small>JUN 25, 2020</small>
								<h6>The new Mediation Policy and other upcoming changes</h6>
								<a href="#">Read More ></a>
							</li>
							<li>
								<small>JUN 25, 2020</small>
								<h6>Why Amar is massively undecutting me?</h6>
								<a href="#">Read More ></a>
							</li>
		...
		<div class="row stats-card">
			<div class="col-md-4 order-fulfillment-card">
				<div class="card">
					<div class="card-header">
						<h4>Your Orders</h4>
					</div>
					<div class="card-body">
						<ul class="summary-list">
							<li>
								...
								@endphp
								<a href="{{ url('admin/order/order?tab=unfulfilled') }}" class="pull-right small" data-toggle="tooltip" data-placement="top" title="{{ trans('app.detail') }}" >
									<div class="summary-inner">
										<p>Unshipped
											<br>
											<small>{{ trans('messages.unfulfilled_percents', ['percent' => $unfulfilled_percents]) }}</small>
										</p>
										<span>{{ $unfulfilled_order_count }}</span>
									</div>
								</a>		
							</li>
							
							<li>
								<a href="{{ route('admin.support.dispute.index') }}" class="pull-right" data-toggle="tooltip" data-placement="top" title="{{ trans('app.take_action') }}" >
									<div class="summary-inner">
										@php
											if(!isset($last_60days_dispute_count))
											{
												$last_60days_dispute_count = 0;
											}

											if(!isset($last_30days_dispute_count))
											{
												$last_30days_dispute_count = 0;
											}
											if(!isset($dispute_count))
											{
												$dispute_count = 0;
											}
										...
										<p>
											Pending
											<br>
											<small>{{ trans('messages.last_30_days_percents', ['percent' => $last_30_days_percents, 'state' => $difference > 0 ? trans('app.increase') : trans('app.decrease')]) }}</small>
										</p>
										<span>{{ $dispute_count }}</span>
									</div>
								</a>
							</li>
						</ul>
						
						<h5>Fulfilled by Amar</h5>
						<ul class="amar-fulfilled">
							<li>
								<div class="summary-inner">
									<p>In Last day</p>
									<span>0</span>
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="summary-list">
							<li>
								@if($last_sale)
								<a href="{{ route('admin.order.order.show', $last_sale->id) }}" class="pull-right small" data-toggle="tooltip" data-placement="top" title="{{ trans('app.detail') }}" >
								@endif
									<div class="summary-inner">
										<p>
											Last Sale
										...
										<span>{{ get_formated_currency($last_sale ? $last_sale->total : 0) }}</span>
									</div>
								@if($last_sale)
								</a>
								@endif
							...
							<li>
								<div class="summary-inner">
									...
									<span>{{ get_formated_currency($todays_sale_amount) }}</span>
								</div>
							</li>
							<li>
								<a href="{{ route('admin.support.dispute.index') }}" class="pull-right" data-toggle="tooltip" data-placement="top" title="{{ trans('app.take_action') }}" >
							...
							<li>
								<a href="{{ url('admin/stock/inventory?tab=out_of_stock') }}" class="pull-right small" data-toggle="tooltip" data-placement="top" title="{{ trans('app.detail') }}" >
									<div class="summary-inner">
											@php
										...
										<span>{{ $stock_out_count }}</span>
									</div>
								</a>
							</li>
							<li>
								<a href="{{ route('admin.support.refund.index') }}" class="pull-right" data-toggle="tooltip" data-placement="top" title="{{ trans('app.take_action') }}" >
									<div class="summary-inner">
										@php
											$last_months = $last_60days_dispute_count - $last_30days_dispute_count;
											$difference = $last_30days_dispute_count - $last_months;
			...
			<!-- Top Selling -->
			<div class="col-md-4 top-selling">
...
@push('styles')
    <style>
		.container-fluid.main-dashboard-wrapper .card {
    padding: 0;
  }
  
  .container-fluid.main-dashboard-wrapper .card-header, .container-fluid.main-dashboard-wrapper .card-body {
    padding: 15px;
  }
  
  .container-fluid.main-dashboard-wrapper h4 {
    margin: 0;
  }
  
  .container-fluid.main-dashboard-wrapper .upper-cards .card {
    height: 335px;
    margin-bottom: 25px;
    position: relative;
  }
  
  .row.upper-cards .card-footer {
    position: absolute;
  }
  ...
  .row.upper-cards .card-footer button {
    width: 100%;
    height: 35px;
...
.main-dashboard-wrapper .card h4 {
    color: #d07e00;
    font-size: 20px;
}
...
.row.upper-cards .form-check {
    padding: 0 10px;
}

.row.upper-cards .form-check input{
    margin-right: 20px;
}
...
ul.summary-list, .seller-fulfilled, .amar-fulfilled {
    list-style: none;
    padding: 10px;
}

ul.summary-list .summary-inner, .seller-fulfilled .summary-inner, .amar-fulfilled .summary-inner {
    display: flex;
    flex: 1;
}

ul.summary-list .summary-inner p, ul.seller-fulfilled .summary-inner p, ul.amar-fulfilled .summary-inner p {
    flex: 1;
}

ul.summary-list li, ul.seller-fulfilled li, ul.amar-fulfilled li {
    display: flex;
    align-items: center;
    padding: 10px 0;
    border-bottom: solid;
...
.col-md-4.order-fulfillment-card h5 {
    font-weight: 700;
    font-size: 16px;
    margin-bottom: 0;
}
...
.col-md-4.order-fulfillment-card .card-body {
    padding-top: 0;
}

.col-md-4.order-fulfillment-card .card-header {
    padding-bottom: 0;
}
...
.col-md-4.order-fulfillment-card .card-footer {
    text-align: center;
    padding: 10px;
}
