<div class="col-md-8 hidden">
    <div class="box">
      ...
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-md-3 nopadding-left">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::checkbox('has_variant', null, !isset($product) ? 1 : null, ['id' => 'has_variant', 'class' =>
                'icheckbox_line']) !!}
          ...
          <div class="col-md-9 nopadding-right">
            <div class="form-group">
              ...
              {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.title'),
              'required']) !!}
              <div class="help-block with-errors"></div>
            </div>
          </div>
        ...
        <div class="form-group">
          ...
          {!! Form::textarea('description', null, ['class' => 'form-control summernote', 'rows' => '4', 'placeholder' =>
          trans('app.placeholder.description'), 'required']) !!}
  ...
  <div class="col-md-4 nopadding-left hidden">
    <div class="box">
      <div class="box-header with-border">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            {!! Form::checkbox('requires_shipping', null, !isset($product) ? 1 : null, ['id' => 'requires_shipping',
        ...
        <fieldset>
          ...
          <span class="input-group-addon" id="basic-addon1">
            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="left"
              title="{{ trans('help.downloadable') }}"></i>
          </span>
      </div>
    </div> --}}
      ...
      <div class="col-md-6 nopadding-right">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            {!! Form::number('min_price' , null, ['class' => 'form-control', 'step' => 'any', 'min' => '0','placeholder'
            => trans('app.placeholder.catalog_min_price')]) !!}
          </div>
          <div class="help-block with-errors"></div>
        </div>
      </div>
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        {!! Form::select('origin_country', $countries , null, ['class' => 'form-control select2', 'placeholder' =>
        trans('app.placeholder.origin')]) !!}
        <div class="help-block with-errors"></div>
      </div>
      ...
      <div class="form-group">
        ...
        {!! Form::select('manufacturer_id', $manufacturers , null, ['class' => 'form-control select2', 'placeholder' =>
        trans('app.placeholder.manufacturer')]) !!}
        <div class="help-block with-errors"></div>
      </div>
