            ...
            <div class="row">
              <div class="col-md-6 nopadding-right">
                <div class="form-group">
                  ...
                  {!! Form::number('stock_quantity', 1, ['min' => 0, 'class' => 'form-control', 'placeholder' => trans('app.placeholder.stock_quantity'), 'required']) !!}
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              ...
              <div class="col-md-6 nopadding-left">
                <div class="form-group">
                  ...
                  {!! Form::number('min_order_quantity', 1, ['min' => 1, 'class' => 'form-control', 'placeholder' => trans('app.placeholder.min_order_quantity')]) !!}
                </div>
              </div>
            </div>
          @endif
      ...
      <div class="box-body">
        ...
        @if($requires_shipping)
          <fieldset>
            ...
            <div class="form-group">
              ...
              {!! Form::text('packaging_list[]', null, ['class' => 'form-control select2-normal', 'multiple' => 'multiple']) !!}
            </div>
          </fieldset>
        @endif
        ...
        <fieldset>
          ...
          @if($requires_shipping)
            <div class="form-group">
              ...
              {!! Form::text('supplier_id', null, ['class' => 'form-control select2', 'placeholder' => trans('app.placeholder.select')]) !!}
            </div>
          @endif
        </fieldset>
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            {!! Form::text('tag_list[]', null, ['class' => 'form-control select2-tag', 'multiple' => 'multiple']) !!}
          </div>
