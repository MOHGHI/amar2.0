                            ...
                            <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    {!! Form::text('title', isset($product->name) ? $product->name : null, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.title'), 'required']) !!}
                                    <div class="help-block with-errors"></div>
                                  </div>
                                </div>
                                <div class="col-md-12 hidden">
                                 
                                    {!! Form::text('product_id', isset($product->id) ? $product->id : null, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.title'), 'required']) !!}
                                </div>
                            ...
                            <div class="row">
                              <div class="col-md-6 nopadding-right">
                                <div class="form-group">
                                  ...
                                  {!! Form::number('stock_quantity', isset($inventory) ? null : 1, ['min' => 0, 'class' => 'form-control single-stock', 'placeholder' => trans('app.placeholder.stock_quantity'), 'required']) !!}
                                  <div class="help-block with-errors"></div>
                                </div>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 nopadding-left">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <span class="input-group-addon">{{ config('system_settings.currency_symbol') ?: '$' }}</span>
                                    <input name="sale_price" value="{{ isset($inventory) ? $inventory->sale_price : Null }}" type="number" min=""  step="any" placeholder="{{ trans('app.placeholder.sale_price') }}" class="form-control single-price" required="required">
                                  </div>
                                  <div class="help-block with-errors"></div>
                                </div>
                              </div>
