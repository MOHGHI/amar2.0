<fieldset>
  <legend class="text-left">{{ trans('app.form.key_features') }}
  ...
  <div id="DynamicInputsWrapper">
    @if(isset($inventory))
      @foreach($inventory as $key_feature)
        <div class="form-group">
          <div class="input-group">
            {!! Form::text('key_features[]', unserialize($key_feature->key_feature), ['class' => 'form-control input-sm', 'placeholder' => trans('app.placeholder.key_feature')]) !!}
...
<div class="form-group hidden">
  ...
  {!! Form::textarea('description', $description, ['class' => 'form-control summernote', 'placeholder' => trans('app.placeholder.description')]) !!}
</div>