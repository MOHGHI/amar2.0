    ...
    <div class="row main-row">
        ...
        <div class="col-md-5 nopadding">
            <div class="box login-box-body">
                ...
                <h3 class="box-title text-center">{{ trans('app.form.login') }}</h3>
                </div> <!-- /.box-header -->
                
                <div class="box-body">
                <div class="login-logo-wrapper" style="background: #01411c">
                ...
                <a class="btn btn-link text-center merchant-register-btn" href="{{ route('register') }}" class="text-center">{{ trans('app.form.register_as_merchant') }}</a>
            </div>
        </div>
    </div>
@endsection