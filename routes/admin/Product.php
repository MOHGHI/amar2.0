<?php
	...
	Route::post('product/combinations', 'ProductController@combinations')->name('product.combinations');
	...
	Route::post('product/result', 'ProductController@result')->name('product.result');
	Route::post('product/sell', 'ProductController@sell')->name('product.sell');
	Route::post('product/storeWithVariant', 'ProductController@storeWithVariant')->name('product.storeWithVariant');
	Route::post('product/createInventory', 'ProductController@createInventory')->name('product.createInventory');
	Route::post('product/addToMyShop', 'ProductController@addToMyShop')->name('product.addToMyShop')->middleware('ajax');
