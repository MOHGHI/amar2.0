<div id="ei-slider" class="ei-slider">
    <span class="slider-nav fa fa-chevron-left"></span>
    <ul class="ei-slider-large">
        @foreach($sliders as $slider)
            <li>
                <a href="{{ $slider['link'] }}">
                    <img src="{{ get_storage_file_url($slider['featured_image']['path'], '') }}" alt="{{ $slider['title'] ?? 'Slider Image ' . $loop->count }}">
                </a>
                <div class="ei-title">
    ...
    <span class="slider-nav fa fa-chevron-right"></span>
