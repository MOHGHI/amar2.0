        ...
        <div class="container"> 
            ...
            <div class="row video-section">
                ...
                <div class="video-wrapper">
                    <img src="{{ selling_theme_asset_url('img/buy-bg.jpg') }}" class="buy-bg" alt="LOGO" title="LOGO" />
                    <img src="{{ asset('images/' . 'logoG.png') }}" alt="LOGO" title="LOGO" />
                    <i class="fa fa-play"></i>
                </div>
            </div>
                <div class="col-md-6">
                    <h3 class="buy-text">Lorem Ipsum</h3>
                    <p>
                                ...
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-image">
                                            <img class=" img-responsive" src="{{ selling_theme_asset_url('img/register.png') }}" alt="">
                                        </div>
                                    ...
                                    <li class="timeline-inverted">
                                        <div class="timeline-image">
                                            <img class=" img-responsive" src="{{ selling_theme_asset_url('img/product.png') }}" alt="">
                                        </div>
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h4>&nbsp;</h4>
                                    ...
                                    <li>
                                        <div class="timeline-image">
                                            <img class=" img-responsive" src="{{ selling_theme_asset_url('img/logistics.png') }}" alt="">
                                        </div>
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h4>&nbsp;</h4>
                                    ...
                                    <li class="timeline-inverted">
                                        <div class="timeline-image">
                                            <img class=" img-responsive" src="{{ selling_theme_asset_url('img/pay.png') }}" alt="">
                                        </div>
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h4>&nbsp;</h4>
